...
private:
    ...
    void set_pneumatic(const std_msgs::msg::Bool &msg);
    ...
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr pneumatic_sub;
    ...
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr intake_proximity_top_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr intake_proximity_bottom_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr intake_proximity_middle_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr proximitysilo_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr proximityback_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr proximityavoid_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr button_start_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr button_stop_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr button_restart_pub;
    /* Timer */
